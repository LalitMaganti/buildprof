...
`.github/workflows/release.yml` is generated by dist, but two things dist
...
file, reapply the "Create GitHub Release" step, and run `actionlint` on the
result. Keep the install commands in `infra/release-notes`, the README, and
